...
export function reference() {
  return [
    ...
    <section data-visibility="hidden">
      <h2>Hidden Slides</h2>
      <p>
        This slide is visible in the source, but hidden when the presentation is
        viewed. You can show all hidden slides by setting the `showHiddenSlides`
    ...
    <section>
      ...
      <p>
        ...
        <a href="http://lab.hakim.se/zoom-js">zoom.js</a>. Click again to zoom
        back out.
      </p>
        ...
        <a
          ...
          onclick={() => {
            document
              ...
              .setAttribute("href", "dist/theme/black.css");
            return false;
          }}
        >
          Black (default)
    ...
    <section>
      ...
      <section data-background-gradient="linear-gradient(to bottom, #283b95, #17b2c3)">
        ...
        <pre>
          <code class="hljs html wrap">
            &lt;section data-background-gradient= "linear-gradient(to bottom,
            #ddd, #191919)"&gt;
          </code>
        </pre>
      </section>
    ...
    <section data-state="customevent">
      ...
      <pre>
        ...
        >
          Reveal.on( 'customevent', function() {"{"}' console.log(
          '"customevent" has fired' );
          {"}"}' );
        </code>
      </pre>
    </section>,
